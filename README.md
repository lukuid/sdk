...
| Swift Package Manager | `.package(url: "https://github.com/lukuid/sdk.git", from: "1.0.17")` |
| CocoaPods | `pod 'LukuIDSDK', '~> 1.0'` |
| Android / Maven Central | `implementation("com.lukuid:lukuid-sdk-android:1.0.17")` |
